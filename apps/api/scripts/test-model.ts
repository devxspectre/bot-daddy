import modelProvider from "../core/model";
...
async function runTests() {
    ...
    try {
        const embedding = await modelProvider.generateEmbedding("Hello, world!");
    ...
    try {
        const text = await modelProvider.generateText("Write a one sentence greeting.");
