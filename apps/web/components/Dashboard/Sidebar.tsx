...
const navigation = [
  ...
  { name: "Knowledge Base", href: "/dashboard/knowledge-base", icon: Files },
...
export function Sidebar() {
  ...
  return (
    <div 
      className={cn(
        "relative flex flex-col h-[75vh] my-auto ml-4 rounded-2xl border bg-card/80 backdrop-blur-xl shadow-2xl z-50 overflow-hidden ring-1 ring-white/10 w-80",
      )}
    >
